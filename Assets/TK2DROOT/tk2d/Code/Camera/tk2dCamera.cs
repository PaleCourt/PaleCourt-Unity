...
public class tk2dCamera : MonoBehaviour 
{
	...
	public Camera ScreenCamera {
		get {
			bool viewportClippingEnabled = this.viewportClippingEnabled && inheritSettings != null && inheritSettings.UnityCamera.rect == unitRect;
			return viewportClippingEnabled ? inheritSettings.UnityCamera : UnityCamera;
		}
	}
	...
	private void Upgrade() {
		if (version != CURRENT_VERSION) {
			...
			Debug.Log("tk2dCamera '" + name + "' - Upgraded from version " + version.ToString());
